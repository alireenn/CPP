...
/*   Updated: 2023/01/12 16:03:38 by anovelli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "RobotomyRequestForm.hpp"

RobotomyRequestForm::RobotomyRequestForm() : Form("Robotomy Request Form", 72, 45), _target(target)
{
	std::cout << "Default costructor for RobotomyRequestForm called" << std::endl;
}

RobotomyRequestForm::RobotomyRequestForm(std::string const &target) : _target(target) Form("Robotomy Request Form", 72, 45), _target(target)
{
	this->_target = target;
